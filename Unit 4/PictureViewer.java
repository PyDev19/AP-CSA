//Name - Atharva Mishra
//Class - Patterson 3B
//Description - This class is used to view the pictures.
...
public class PictureViewer {
    ...
    private static String makeLabelText(Point cursor, Color color) {
        return String.format(
                "<html><div style='text-align: center;'>Row: %d, Col: %d<br><font color=\"red\">Red</font> = %d, <font color=\"green\">Green</font> = %d, <font color=\"blue\">Blue</font> = %d</div></html>",
                cursor.y, cursor.x, color.getRed(), color.getGreen(), color.getBlue());
    }
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = -5; i <= 5; i++) {
                ...
                if (p.x >= 0 && p.x < size.width)
                    g.fillRect(p.x * zoom, p.y * zoom, zoom, zoom);
